        ...
        <Card key={index} className="col-span-10 md:col-span-5 lg:col-span-2 bg-white shadow-md">
          <CardContent className="p-6">
            <div className="flex flex-col items-center text-center">
              ...
              >
                <star.icon className="w-6 h-6" style={{ color: star.color }} />
              </div>
              <h3 className="font-semibold text-sm text-gray-600 mb-1">{star.title}</h3>
              <p className="text-xs mb-2" style={{ color: star.subtitleColor }}>{star.subtitle}</p>
              <p className="text-2xl font-bold" style={{ color: star.color }}>{star.value}</p>
            </div>
          </CardContent>
        </Card>
      ))}
