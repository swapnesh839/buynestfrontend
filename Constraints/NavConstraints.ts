...
interface UserNavType {
    ...
    register: { path: "/register"; UserType: ["user"]; id: "register"; icon: typeof FileUser };
    ...
    saved: { path: "/saved"; UserType: ["user"]; id: "saved"; icon: typeof Heart };
    ...
    // support: { path: "/support"; UserType: ["user", "subadmin"]; id: "support"; icon: typeof BadgeHelp };
...
interface AdminNavType {
    ...
    // help: { path: "/help", UserType: ["user", "admin", "subadmin"], id: "help", icon:typeof HelpCircle }
}
...
const UserNav: UserNavType = {
    ...
    register: { path: "/register", UserType: ["user"], id: "register", icon:FileUser },
    ...
    saved: { path: "/saved", UserType: ["user"], id: "saved", icon: Heart },
    ...
    // support: { path: "/support", UserType: ["user", "subadmin"], id: "support", icon: BadgeHelp },
    // supportdesk: { path: "/supportdesk", UserType: ["user", "subadmin"], id: "supportdesk", icon: BadgeHelp },
    ...
    // help: { path: "/help", UserType: ["user", "admin", "subadmin"], id: "help", icon: HelpCircle }
};
