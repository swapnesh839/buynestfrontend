...
import { Eye, EyeOff, Lock, Mail, ArrowLeft, Shield, ArrowLeftCircle } from 'lucide-react'
...
export default function Registeruser() {
  ...
  return (
    <div className="bg-white flex items-center justify-center w-full fixed top-0 left-0 h-screen z-[1000]">
      <ScrollArea className="w-full h-full flex items-center m-auto justify-center relative">
        <ArrowLeftCircle className='absolute top-0 left-0 m-3 cursor-pointer' color='#00A19C' onClick={()=>{router.back()}}/>
        <Card className="w-full mx-auto max-w-2xl m-auto">
